 ...
 * @author Felippe
 */
public class ComissariaUm implements Tripulante{
    
    private ComissariaUm() {}
    private static ComissariaUm instance = null;
    ...
    public static ComissariaUm get () {
        
        if (instance == null){
            
            instance = new ComissariaUm();
